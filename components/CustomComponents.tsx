...
export const ImageVortex = () => {
  return (
    <Card className="border-none drop-shadow-[0_0px_79px_rgba(56,114,270,0.5)]">
      <CardContent className="flex flex-col lg:flex-row items-center justify-center gap-0">
        <Image
          src={legal}
          alt="boba"
          className="rounded-xl -rotate-12 mt-20 hover:scale-110 transition-all shadow-lg shadow-gray-300/[0.2] drop-shadow-[0_0px_79px_rgba(71,214,70,0.5)] "
          height={160}
        />
        <Image
          src={boba}
          alt="boba"
          className="rounded-xl h-52 w-96 z-40 hover:scale-110 transition-all shadow-lg shadow-indigo-400/[0.2] drop-shadow-[0_0px_79px_rgba(200,14,170,0.5)] "
        />
        <Image
          src={incog}
          alt="boba"
