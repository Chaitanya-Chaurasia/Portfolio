...
const companies = [
  {
    ...
    laymanfont: "Tilt neon, sans-serif",
  },
  {
    ...
    image: asu,
    font: "The Girl Next Door, sans-serif",
    layman:
        ...
        {companies.map((company, index) => (
          <TimelineItem key={index} className="gap-5">
            <TimelineOppositeContent color="textSecondary">
              <div className="flex w-full flex-[1_1_0%] items-center justify-center  p-1">
            ...
            <TimelineContent className="flex flex-col gap-3">
              ...
              <div className="flex flex-col lg:flex-row gap-5 p-5 rounded-3xl box ">
                <div className="flex flex-[2_2_0%] flex-col gap-2">
                  <div
                    style={{
                      fontSize: 30,
                    }}
